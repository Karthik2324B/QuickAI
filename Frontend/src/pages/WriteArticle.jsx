    ...
    <div className='h-full flex flex-wrap items-start p-6 gap-4 text-slate-700 overflow-y-scroll'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full border border-gray-200 bg-white rounded-lg max-w-sm p-4'>
        <div className='flex items-center gap-3'>
          ...
          <h1 className='text-xl font-semibold'> Artificial configuration</h1>
        </div>
        ...
        <button 
          disabled={loading} 
          className='w-full flex items-center justify-center gap-2 cursor-pointer rounded-lg text-sm bg-gradient-to-r from-[#226BFF] to-[#65ADFF] text-white px-4 py-2 mt-6'
        >
          {loading ? (
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 max-h-[600px]'>
        ...
        {!content ? (
          ...
          <div className='mt-3 h-full overflow-y-auto text-sm text-slate-600 reset-tw max-w-sm'>
